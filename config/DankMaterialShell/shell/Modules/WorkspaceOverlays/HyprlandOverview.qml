        ...
        sourceComponent: Variants {
            ...
            PanelWindow {
                ...
                Rectangle {
                    ...
                    anchors.fill: parent
                    color: "black"
                    opacity: overviewScope.overviewOpen ? 0.72 : 0
                ...
                Item {
                    ...
                    Loader {
                            ...
                            sourceComponent: OverviewWidget {
                                ...
                                onDismissRequested: overviewScope.overviewOpen = false
                            }
                        }
                    }
                }
                ...
                FocusScope {
                    ...
                    // Cover the entire overview and accept scrolling on both axes.
                    // No mouse buttons: clicks still reach window/workspace previews.
                    MouseArea {
                        anchors.fill: parent
                        ...
                        onWheel: event => {
                            if (overviewLoader.item)
                                overviewLoader.item.handleCarouselWheel(event);
                        }
                    }
                    ...
                    Keys.onPressed: event => {
                        ...
                        if (event.key === Qt.Key_Left || event.key === Qt.Key_Right) {
                            if (!overviewLoader.item)
                                return;
                            overviewLoader.item.switchWorkspaceRelative(event.key === Qt.Key_Left ? -1 : 1);
                            event.accepted = true;
                        }
                    }
